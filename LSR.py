...
TOKEN = '8342893449:AAFBmNhwN9Wy08sxQuIp4k_pezbfwqVZ5TQ'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@LSR.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -5209208239
CHANNEL_ID = -5209208239
error_channel_id = -5209208239
...
bot = telebot.'8393405899:AAGasMwFSp6gvpTFhtOqGIG0zUOsS6WgUho'
REQUEST_INTERVAL = 1
...
def update_proxy_command(message):
    ...
    try:
        update_proxy()
        bot.send_message(5209208239, "Proxy updated successfully.")
    except Exception as e:
        bot.send_message(5209208239, f"Failed to update proxy: {e}")
